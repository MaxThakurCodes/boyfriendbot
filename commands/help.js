...
exports.run = async (client, msg, args) => {
  ...
  let embed = new Discord.MessageEmbed()
    ...
    .addField(`:sparkles: Help Support the Bot!`, `*Feel free to vote for boyfriend bot to help him get noticed by more people [here](https://bit.ly/BoyfriendVote)!*`)
    .addField(`:fist_tone5: Black Lives Matter`, `*Black lives matter today, black lives matter tommorow, Black lives matter every day after that. Click [here](https://blacklivesmatters.carrd.co) to learn how to help.*`)
