...
exports.run = async (client, msg, args) => {
  let embed = new Discord.MessageEmbed()
    ...
    .addField('UPDATES -  1.0.9 𝐟𝐢𝐧𝐚𝐥 𝐚𝐥𝐩𝐡𝐚', "New profile picture for Boyfriend Bot! We fixed up a few things and added the `-gametruth` and `-gamedare` commands. See you on the otherside in Beta!(6/23/2020)")
